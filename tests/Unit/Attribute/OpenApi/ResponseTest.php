...
final class ResponseTest extends TestCase
{
	...
	#[Test]
	public function listRefArrayWithMeta(): void
	{
		$response = new Response(
			response: 200,
			listRef: [TestUserDto::class, TestAdminDto::class],
	...
	#[Test]
	public function listRefArrayWithCustomDescription(): void
	{
		$response = new Response(
			response: 200,
			description: 'List of mixed content',
			listRef: [TestUserDto::class, TestAdminDto::class],
			withMeta: true,
		);
		...
		self::assertSame('List of mixed content', $spec['description']);
	}
