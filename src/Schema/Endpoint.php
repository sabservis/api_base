...
class Endpoint
{
	...
	{
		return $this->openApi->getDescription();
	}

	public function setDescription(string|null $description): void
	{
		$this->openApi->setDescription($description);
	}
	...
	// === Security (delegated to OpenApiDefinition) ===

	/**
	 * @return array<array<string, array<string>>>|null
	 */
	public function getSecurity(): array|null
	{
		return $this->openApi->getSecurity();
	}

	/**
	 * @param array<array<string, array<string>>>|null $security
	 */
	public function setSecurity(array|null $security): void
	{
		$this->openApi->setSecurity($security);
	}
